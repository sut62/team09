...
public class SpringBootVueApplication {
	...
	ApplicationRunner init(RegisterpatientRepository registerpatientRepository, GenderRepository genderRepository,
		...
		return args -> {
			...
			Stream.of("กรดไหลย้อน", "ไข้หวัดใหญ่", "โรคเบาหวาน", "โรคภูมิแพ้", "โรคความดันโลหิตสูง", "ไขมันในเลือดสูง",
					 "โรคหลอดเลือดหัวใจ","ถุงลมโป่งพอง", "ธาลัสซีเมีย", "กรวยไตอักเสบ", "มะเร็งปากมดลูก", "มะเร็งเต้านม",
					"โรคหืด (หอบหืด)", "โรคอ้วน/น้ำหนักตัวเกิน", "วัณโรค", "ไข้เลือดออก","ปอดอักเสบ (ปอดบวม)",
					 "โรคมือเท้าปาก", "อีสุกอีใส", "อาหารเป็นพิษ", "พิษสุนัขบ้า", "ซิฟิลิส")
					.forEach(name -> {
