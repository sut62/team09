...
public class SpringBootVueApplication {
	...
	ApplicationRunner init(RegisterpatientRepository registerpatientRepository, GenderRepository genderRepository,
		...
		return args -> {
			...
			Stream.of("ไม่มีโรคประจำตัว","โรคหัวใจ", "โรคความดันโลหิตสูง", "โรคความดันโลหิตต่ำ", "โรคเบาหวาน",
			...
			Stream.of("กรดไหลย้อน", "โรคเบาหวาน", "โรคความดันโลหิตสูง", "ไขมันในเลือดสูง")
					.forEach(name -> {
			...
			Stream.of("ไม่ต้อง", "งดเครื่องดื่ม งดอาหาร อย่างน้อย 8-10 ชั่วโมงก่อนการตรวจ",
